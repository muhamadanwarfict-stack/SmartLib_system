...
class User {
    ...
    public function login($username, $password) {
        $query = "SELECT id, username, password, nama_lengkap, email, user_role 
    ...
    public function create() {
        ...
        $stmt->bindParam(':user_role', $this->role);
    ...
    public function readAll() {
        $query = "SELECT id, username, nama_lengkap, email, user_role, created_at 
                  FROM " . $this->table_name . " 
    ...
    public function readOne() {
        $query = "SELECT id, username, nama_lengkap, email, user_role 
                  FROM " . $this->table_name . " 
                  WHERE id = :id";
